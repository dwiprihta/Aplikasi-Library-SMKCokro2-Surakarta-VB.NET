...
Public Class lap_penerbit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "perpuskita.com.lap_penerbit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_penerbit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_penerbit = New lap_penerbit()
        rpt.Site = Me.Site
        Return rpt
    End Function

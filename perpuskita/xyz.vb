...
Public Class xyz
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cetak_kartu() As CrystalDecisions.[Shared].IParameterField
        Get
